...
namespace ClsOrderDetailBusinessLayer
{
    public class ClsOrderDetail
    {
        ...
        private ClsOrderDetail(int OrderDetailID, int OrderID, int ItemID, int Quantity, decimal Price)
        {
        ...
        {
            this.OrderDetailID = (int)ClsOrderDetailData.AddNewOrderDetail(this.OrderID, this.ItemID, this.Quantity, this.Price);
            return (this.OrderDetailID != -1);
        }
        private bool _UpdateOrderDetail()
        {
            return ClsOrderDetailData.UpdateOrderDetail(this.OrderDetailID, this.OrderID, this.ItemID, this.Quantity, this.Price);
        }
        ...
        public static ClsOrderDetail FindByOrderDetailID(int OrderDetailID)
        {
            ...
            bool IsFound = ClsOrderDetailData.GetOrderDetailByOrderDetailID(OrderDetailID, ref OrderID, ref ItemID, ref Quantity, ref Price);

            if (IsFound)
                return new ClsOrderDetail(OrderDetailID, OrderID, ItemID, Quantity, Price);
            else
                return null;
        }
        public static ClsOrderDetail FindByOrderID(int OrderID)
        {
            ...
            bool IsFound = ClsOrderDetailData.GetOrderDetailByOrderID(ref OrderDetailID, OrderID, ref ItemID, ref Quantity, ref Price);
        ...
        public static ClsOrderDetail FindByItemID(int ItemID)
        {
            ...
            bool IsFound = ClsOrderDetailData.GetOrderDetailByItemID(ref OrderDetailID, ref OrderID, ItemID, ref Quantity, ref Price);
        ...
        public static ClsOrderDetail FindByQuantity(int Quantity)
        {
            ...
            bool IsFound = ClsOrderDetailData.GetOrderDetailByQuantity(ref OrderDetailID, ref OrderID, ref ItemID, Quantity, ref Price);
        ...
        public static ClsOrderDetail FindByPrice(decimal Price)
        {
            ...
            bool IsFound = ClsOrderDetailData.GetOrderDetailByPrice(ref OrderDetailID, ref OrderID, ref ItemID, ref Quantity, Price);
